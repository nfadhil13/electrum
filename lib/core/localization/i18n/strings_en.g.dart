...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	/// en: 'Join Electrum and start your e-bike journey'
	String get joinElectrumAndStart => 'Join Electrum and start your e-bike journey';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'joinElectrumAndStart' => 'Join Electrum and start your e-bike journey',
			'fullName' => 'Full Name',
